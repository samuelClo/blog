<nav class="col-3 py-2 categories-nav">
    ...
    <?php if(isset($_SESSION['user'])): ?>
        ...
        <p>
            ...
            <?php else: ?>
                <a class="d-block btn btn-warning mb-4 mt-2" href="index.php?page=user-profil">Profile</a>
            <?php endif; ?>
        </p>
    <?php else: ?>
    ...
    <b>Catégories :</b>
    <ul>
        <li><a href="index.php?page=article-list">Tous les articles</a></li>
        <!-- liste des catégories -->
        <?php foreach($categories as $category): ?>
            <li><a href="index.php?page=article-list&category_id=<?= $category['id']; ?>"><?= $category['name']; ?></a></li>
        <?php endforeach; ?>
    </ul>
</nav>
